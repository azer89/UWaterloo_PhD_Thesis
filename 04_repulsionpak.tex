...
\textbf{Rigid packing:}
As discussed in Chapter~\ref{chapter_related_work}, a good number of past research  used
rigid transformations to pack elements, they include
Hausner~\cite{Hausner2001}, Hiller et al.~\cite{Hiller2003}, 
Smith et al.~\cite{Smith2005}, Dalal et al.~\cite{Dalal2006},
and Gal et al.~\cite{Gal2007B}.

Our work is most similar to Jigsaw
...
\mynote{meh}
% read Physically Based Deformable Models in Computer Graphics

\textbf{Physically-based methods:}
There are many sophisticated physical simulation methods,
such as Position Based Dynamics~\cite{Muller2007}, 
Projective Dynamics~\cite{Bouaziz2014}, and the Finite Element Method.
We decide to use a mass-spring system for RepulsionPak since it is simple to implement and 
