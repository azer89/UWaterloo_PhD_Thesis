...
Repulsion forces act onto vertices that are grouped into elements using elastic springs, 
effectively pack and deform them without computing a Voronoi diagram.
}
...
This representation allows them to synthesize texture withs elements
that have more complex shapes, such as long-shaped elements, 3D elements, or animated elements.
