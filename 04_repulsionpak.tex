...
RepulsionPak can be categorized as a variant of Lloyd's method that distributes
2D points. To allow RepulsionPak to pack elements and treat them as deformable shapes, 
we made key differences are: (1) We spread vertices but they are binded together by elastic spring,
forming 2D elements. (2) We use repulsion forces to distribute these vertices and we do not compute
a Voronoi diagram.
