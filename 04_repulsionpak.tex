...
In our implementation, The constant $k_g$ is usually set to 0.01.
}
...
\caption[A round element is placed near a sharp convex corner of the container]{
  ...
  \nnewtext
  {
  A packing generated by RepulsionPak.
...
a few elements are not aligned properly with convex corners, especially in the front horn and the legs.}
}
}
\end{figure}
...
\nnewtext{
   ...
   numbers of primary and secondary elements,
   the number of vertices, 
   the running times of the primary and the secondary simulations in seconds,
...
\cellcolor{lg}\makecell{Primary\\running\\time} & 
\cellcolor{lg}\makecell{Secondary\\running\\time} & 
