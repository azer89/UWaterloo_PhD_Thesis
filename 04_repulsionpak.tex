...
balance, uniformity amidst variety, and boundaries \nnewtext{(Chapter~\ref{chapter_introduction}), but less about the flow principle.} 
...
a few elements are not aligned properly with convex corners: a long thin element is severely deformed by the front horn, 
and two elements cannot represent the shape of the back leg properly.}
}
}
\end{figure}
...
\nnewtext{Two artist used RepulsionPak to generate packings in Figure~\ref{paul_daichi_packings}.
However, due to lack of coordination, we were unable to collect the statistics of those packings.}
...
\nnewtext{
   ...
   We were not able to collect statistics from artist-made RepulsionPak packing in Figure~\ref{paul_daichi_packings}}
   }
...
\nnewtext{Real-world artist have used RepulsionPak to create packings shown in Figure~\ref{paul_daichi_packings}.
