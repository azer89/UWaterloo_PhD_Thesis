...
\item \newtext{\textbf{Better Iterative Refinement Process:}}
...
issue in that case.
\newtext{
Another idea is to use RepulsionPak to refine the packing but we
still need to adhere to the vector field.}
...
\item \newtext{\textbf{RepulsionPak in Fabrication:}} 
...
\item \newtext{\textbf{Interactive packings:}
  ...
  al.~\cite{Gieseke2017}, and Hsu et al.~\cite{Hsu2020}, which let the user directly manipulate
