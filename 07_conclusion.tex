...
\nnewtext{We would like to explore techniques to assist users in creating element shapes.}
...
\nnewtext{
Lastly, we would like to investigate a way to identify salient shapes in a source photograph to create fixed elements.
