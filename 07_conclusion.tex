...
\nnewtext{
Another idea is to identify salient shapes in a source photograph.
...
Another idea is to replace these salient regions with highly deformed elements, similar to the calligraphy packing approaches~\cite{Xu2007, Zou2016}.
}
