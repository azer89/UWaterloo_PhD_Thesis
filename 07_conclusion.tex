...
Modular element provides us opportunities to perform a better element placement.
...
\nnewtext{
We believe that collaborations with artists can provide us invaluable criticisms for our deformation-driven methods.
...
\nnewtext{In addition, we would like to develop} an interactive user interfaces for our packing methods.
...
\nnewtext{
Inspired by doodle murals by Joe Whale (Figure~\ref{}), 
...
\nnewtext
{
A young artist, Joe Whale, who is drawing a doodle mural. 
...
An interesting idea would be generating a bas-reliefs using a packing method.
We can also call this as a 2.5D packing.
