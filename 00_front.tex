...
\begin{tabbing}
Internal-External Member Member: \=  \kill % using longest text to define tab length
Internal-External Member: \> \nnewtext{Stephen A. Vavasis} \\
\> Professor, \\ 
\> \nnewtext{Department of Combinatorics and Optimization}, \\
\> University of Waterloo \\
\end{tabbing}
  \bigskip
...
Internal-External Member Member: \=  \kill % using longest text to define tab length
External Examiner: \>  \nnewtext{Karan Singh} \\ 
\> \nnewtext{Professor, Department of Computer Science,} \\
...
\item \nnewtext{Stephen Vavasis, for being my thesis internal-external member}.
\item \nnewtext{Karan Singh, for being my external examiner}.
