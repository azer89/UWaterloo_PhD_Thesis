...
The following served on the Examining Committee for this thesis. The decision of the Examining Committee is by majority vote.
  ...
  \noindent
\begin{tabbing}
Internal-External Member Member: \=  \kill % using longest text to define tab length
Supervisor: \> Craig S. Kaplan \\
\> \newtext{Associate Professor, School of Computer Science,} \\ 
...
\begin{tabbing}
Internal-External Member Member: \=  \kill % using longest text to define tab length
Internal-External Member: \> \newtext{Stephen A. Vavasis} \\
\> Professor, \\ 
\> \newtext{Department of Combinatorics and Optimization}, \\
\> University of Waterloo \\
\end{tabbing}
  \bigskip
...
Internal-External Member Member: \=  \kill % using longest text to define tab length
External Examiner: \>  \newtext{Karan Singh} \\ 
\> \newtext{Professor, Department of Computer Science,} \\
...
see Statement of Contributions included in the thesis. 
...
Dr.\ Craig S.\ \mbox{Kaplan}, Dr.\ Paul Asente, and \newtext{Dr.\ Radom\'{\i}r M\v{e}ch}.
}
...
\newtext{FLOWPAK is also discussed in our publication ``FLOWPAK: Flow-Based Ornamental Element Packing''~\cite{Saputra2017} and in our patent ``Computerized Generation of Ornamental Designs by Placing Instances of Simple Shapes in Accordance With a Direction Guide''~\cite{Asente2020}.
}
...
\newtext{A packing is an arrangement of geometric elements within a container region in the plane.
...
This thesis presents three packing methods that create element compatibilities using shape deformation.}
\newtext{The first method, FLOWPAK, deforms} elements to flow along a vector field interpolated
from user-supplied strokes, giving a sense of visual flow to the final composition.
\newtext{The second method, RepulsionPak, utilizes} repulsion forces to pack
...
\newtext{The last method, AnimationPak, creates} animated packings
...
\item \newtext{Stephen Vavasis, for being my thesis internal-external member}.
\item \newtext{Karan Singh, for being my external examiner}.
