...
\newtext{We present three methods to fill a container shape with deformable instances of geometric elements,
%selected from a library,
creating a artistic composition called a packing.}
