...
\nnewtext{with some degree of deformation to improve the fit with the container.}
\nnewtext{This work falls into the category of static elements inside an animated container.}
}

\textbf{Animated tilings:}
\nnewtext{We discussed metamorphosis tilings in Section~\ref{related_wrok_tiling},
consisting of an element that evolves into another.
Although the entire composition of a metamorphosis tiling is static,
the element evolution be interpreted as a spatial animation.}
