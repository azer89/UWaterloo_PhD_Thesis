...
the repulsion force, the edge force, the boundary force, the overlap force, the torsional force, \newtext{and the temporal force}.
...
so please return back to Chapter~\ref{chapter_repulsionpak} Section~\ref{repulsionpak_simulation}
