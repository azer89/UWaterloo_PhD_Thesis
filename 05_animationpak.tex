...
rigid parts. \nnewtext{Each \newtext{of rigid parts} is then} replaced by a matching element taken from a library.
...
(d) \nnewtext{A set of slices} placed along the time axis.
(e) The vertices on the boundaries of the slices are joined by 
  ...
  \nnewtext{We only show five slices in in~(d) and~(e) for the purpose of visualization. In practice we use a larger number of slices. }
