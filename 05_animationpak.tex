...
for a single shape is shown in Fig.~\ref{fig_discretization}, and
...
(Fig.~\ref{fig_discretization}a).  In our system
...
(Fig.~\ref{fig_discretization}b).  As in RepulsionPak, we will
...
(Fig.~\ref{fig_discretization}c).  First, if two triangles 
...
\newtext{These negative space edges are used exclusively for internal
bracing.  The element's concavities can still be occupied by its
neighbours.}

We refer to the augmented triangulation shown in 
Fig.~\ref{fig_discretization}c as a \textit{slice}.  
...
Fig.~\ref{fig_discretization}d shows a set of time slices, with
...
transformations.
Fig.~\ref{fig_discretization}e shows time edges for $n_s=5$.
...
visualized in Fig.~\ref{fig_spacetime_element}.
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/guided_element.pdf} 
\caption{\label{fig_animationpak_guided_element} A 2D illustration of a guided element.
...
\caption{\label{fig_animationpak_simulation_process} The simulation process. 
...
The artist can \newtext{also} optionally specify scale and
...
in Fig.~\ref{fig_simulation_process}a are guided elements.
...
Fig.~\ref{fig_simulation_process} the two guided elements form a connected
...
collisions.
The blue extrusions in Fig.~\ref{fig_simulation_process}a show an
...
\begin{figure} [t]
\includegraphics[width=1.0\columnwidth]{figures/animationpak/repulsion_force.pdf} 
\vspace{-16pt}
\caption{\label{fig_animationpak_repulsion_force} 
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/t_force.pdf} 
\caption{\label{fig_animationpak_t_force} 
...
\mynote{the difference between RepulsionPak and AnimationPak}
...
(Fig.~\ref{fig_simulation_process}).
...
\begin{figure}
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/collision_grid.pdf} 
\caption{\label{fig_animationpak_collision_grid} 
...
shown in Fig.~\ref{fig_collision_grid}a.  Given a query vertex 
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/constraints.pdf} 
\caption{\label{fig_animationpak_constraints} 
...
(Fig.~\ref{fig_constraints}c), but more general loops are possible in which
the elements arrive at a permutation of their original configuration
(Fig.~\ref{fig_constraints}d).  We require only that there is a one-to-one
...
\begin{figure}
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/growth.pdf} 
\caption{\label{fig_animationpakgrowth} 
...
consuming the negative space around them (Fig.~\ref{fig_growth}a,b).
...
Fig.~\ref{fig_teaser} is an animation of aquatic fauna featuring two
...
Fig.~\ref{fig_teaser}a.  Note the coupling between the Pac-Man fish's
...
Fig.~\ref{fig_chasing_bird}, demonstrating a container with a hole
and giving a simple example of the narrative potential of animated
packings.  Fig.~\ref{fig_penguin_giraffe} animates the giraffe-to-penguin
illusion shown as a static packing in RepulsionPak.  This example
uses torsional forces to control slice orientations.

Fig.~\ref{fig_star_comparison} offers a direct comparison between
...
\newtext{the evenness of the packing} quickly degrades in later frames.
...
Fig.~\ref{fig_lion}a is a static packing of a lion created by an artist and
used as an example in FLOWPAK~\cite{Saputra2017}.  In Fig.~\ref{fig_lion}b,
...
Fig.~\ref{fig_repulsionpak_vs_animationpak} compares
...
Fig.~\ref{fig_teaser_weak_t_springs} emphasizes the trade-off between
temporal coherence and \newtext{evenness of 
negative space} by creating two animations
...
Fig.~\ref{fig_blender} is a failed attempt to animate a ``blender''.
...
\centering 
\caption{
   Data and statistics for the results in the paper.  The table shows the
   number of elements,
...
\makecell{Aquatic animals  \\ (Fig.~\ref{fig_teaser})}  
& 37         & 97,800             & 623,634            & 106,000		& 01:06:35        
\\ \hline
\makecell{Snake and birb     \\ (Fig.~\ref{fig_chasing_bird})}  
& 37         & 58,700             & 370,571            & 58,700		& 01:01:32        
\\ \hline
\makecell{Penguin to giraffe \\ (Fig.~\ref{fig_penguin_giraffe})}  
& 33         & 124,300            & 824,164            & 143,000		& 01:19:50        
\\ \hline
\makecell{Heart stars         \\ (Fig.~\ref{fig_star_comparison}c)}  
& 26         & 85,200             & 598,218            & 858,00		& 00:23:08        
\\ \hline
\makecell{Animals            \\ (Fig.~\ref{fig_repulsionpak_vs_animationpak}b)}  
& 34         & 69,600             & 444,337            & 69,800		& 01:00:19        
\\ \hline
\makecell{Lion               \\ (Fig.~\ref{fig_lion}b)}  
...
\caption{\label{fig_chasing_bird} 
...
\caption{\label{fig_penguin_giraffe} 
...
\caption{\label{fig_star_comparison} 
...
\begin{minipage}{.47\textwidth}
  ...
  %  \paul{Do we need to say this both in the text and caption?}
  }
  \label{fig_lion}
\end{minipage}%
\hspace{0.4cm}
\begin{minipage}{.47\textwidth}
  ...
  \label{fig_repulsionpak_vs_animationpak}
\end{minipage}
\end{figure*}
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/teaser_weak_t_springs.pdf} 
\caption{\label{fig_teaser_weak_t_springs} 
(a) One frame from Fig.~\ref{fig_teaser}.
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\columnwidth]{figures/animationpak/blender.pdf} 
\caption{\label{fig_blender} 
...
\item As noted in Sect.~\ref{section_rendering} and Fig.~\ref{fig_blender},
...
\item Saputra et al.~\cite{Saputra2018} previously studied a set of
	measurements inspired by spatial statistics for evaluating the 
	evenness of the distribution of negative space in a static packing.
	While their measurements extend naturally to three purely spatial
	dimensions, it is not clear whether they can be 
	adapted to our spacetime context.  We would like to investigate
