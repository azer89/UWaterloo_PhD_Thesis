...
They must also be chosen relative to
...
a loose bird as a guided element that is not constricted inside a container.
The loose bird moves from left to right, passing through the container.
Some slices of the loose bird are inside the container, taking up more space,
so that smaller birds have to stop some of their slice growths prematurely.
...
In the resulted 2D animation, the non-uniform slice sizes create the shrinking-and-expanding effect on 2D elements.
}
...
\newtext{An animation of a loose bird enters and leaves a packing of smaller birds inside a star. 
The smaller birds adapt to the more limited space by prematurely stop some of their slices' growths.}
}
\end{figure*}
