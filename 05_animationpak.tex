...
to synthesize an animated texture of a group of identical elements, such as shoals or particles.
...
We created the results in this \newtext{chapter} using a Windows PC with a 
...
Like the spectral method~\cite{Dalal2006}, and unlike
  ...
  elements into a static container.  As seen in Figure~\ref{fig_animationpak_categorization}, 
  no one has done a packing of animated elements inside an animated container. 
  \nnewtext
  { The packing with a loose bird in Figure~\ref{fig_bib_entering_star} has its
  elements that can vary their slice sizes to adapt to changes in container area.
  We are also interested in adding and removing elements,
