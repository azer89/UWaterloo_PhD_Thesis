...
\nnewtext{a given vertex $\bm{x}$ accumulates repulsion forces from points at different time positions on neighbouring elements.}
...
\nnewtext{The visualization in (c) shows the trajectories of two identical elements in both cases, 
