...
\newtext
{
AnimationPak~\cite{Saputra2020} is a technique
to pack animated 2D elements.
}
...
(Figure~\ref{fig_animationpak_discretization}b).  As in RepulsionPak, we will
...
(Figure~\ref{fig_animationpak_discretization}c).  First, if two triangles 
...
(Figure~\ref{fig_animationpak_simulation_process}).
