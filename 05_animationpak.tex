...
\textbf{Spacetime texture synthesis:}
Ma et al.~\cite{Ma2013} proposed a texture synthesis approach
to generate motions of a group of identical elements, such as shoal or particles.
For each element in an examplar,
...
\newtext{
Figure~\ref{fig_bib_entering_star} shows an unconfined bird enters a packing of smaller birds inside a star.
...
causing them to stop their growths prematurely.
In the resulted 2D animation, it creates the effect of 
shrinking elements that give up their space to accommodate another element.
}
...
\newtext{An unconfined bird enters a star-shaped packing. 
