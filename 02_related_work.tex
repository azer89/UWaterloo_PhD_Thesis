...
so that darker regions ``attract'' more point elements and the resulting point distribution
...
\newtext
{
Lin et al.~\cite{Lin2018} generated ground-reversal arrangements that resemble Escher's Sky and Water I,
...
\newtext
{
For more complex shapes, a single point representation is not enough.
