...
where a region with low intensity indicates a denser area. 
...
\nnewtext{A data-driven method requires an input element library to find compatible elements (Figure~\ref{fig_related_jim_pad}).}
