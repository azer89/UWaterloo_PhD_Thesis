...
\nnewtext
{
An informal taxonomy of element arrangements with the focus on element packings.
}
}
\end{figure}
...
Many related packing methods discussed in this chapter aim to minimize element overlaps. 
Looking closely, few packings shown in this chapter 
...
but technically, these two can be grouped into a single category
as methods to generate 2D mosaics or packings are intertwined to each other.
}
