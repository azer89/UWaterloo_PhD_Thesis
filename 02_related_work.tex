...
\nnewtext
{
A taxonomy of packing methods with representative examples.
From upper middle to lower right, images are taken from 
Kaplan and Salesin~\cite{Kaplan2000} (Tilings), 
AlMeraj et al.~\cite{AlMeraj2013} (Discrete Textures),
Hausner~\cite{Hausner2001} (2D Packings/Mosaics),
Gal et al.~\cite{Gal2007B} (3D Packings), 
Chen et al.~\cite{Chen2017} (Packings on Surfaces), 
and Saputra et al.~\cite{Saputra2020} (Animated Packings).
}
}
\end{figure}
