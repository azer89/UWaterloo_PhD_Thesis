...
Figure~\ref{fig_taxonomy} shows the taxonomy of elements arrangements subcategories.
...
Many previous techniques discussed in this chapter aim to avoid or
minimize element overlaps, even though a few figures shown in this thesis 
