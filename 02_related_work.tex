...
%so that darker regions ``attract'' more point elements 
...
a deformation-driven method allows elements to create compatibilities and shape variations.
...
portrait paintings byGiuseppe Arcimboldo.
