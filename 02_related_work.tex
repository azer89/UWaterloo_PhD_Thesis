...
\caption[A taxonomy of element arrangements]
{\label{fig_taxonomy} 
\nnewtext
{
An informal taxonomy of element arrangements with the focus on 2D mosaics/packings.
}
}
\end{figure}
...
\nnewtext
{
A categorization of packing methods. The illustrations are adapted from the spectral approach~\cite{Dalal2006}, 
Pyramid of Arclength Descriptors~\cite{Kwan2016}, and
RepulsionPak~\cite{Saputra2018, Saputra2019}
(a) Lloyd's method starts with an initial distribution of elements then iteratively distribute them
to generate an even distribution. 
...
Figure~\ref{fig_taxonomy} shows an informal taxonomy of elements arrangements 
that is focused on packings, tilings, and discrete textures as they are more related to our proposed methods.
We further break down the mosaics and packing category into subcategories, each discussed in a separate section.
Many packing methods discussed in this chapter aim to minimize element overlaps. 
Looking closely, a few computer-generated packings shown in this chapter 
...
%\nnewtext
%{
%This section discusses previous methods to arrange 2D elements tightly in a 2D container.
%Elements in traditional mosaics are made of stone, ceramics, or glass.
%We can argue that traditional mosaics have a different visual style than 2D packings in graphic design,
%but these two can be grouped into a single category of tight arrangements of 2D elements.
%}
...
\nnewtext{
A standard CVD assumes the area density is uniform everywhere.
...
\newtext
{
A standard CVD is generated using Euclidean distance, but other metrics lead to different shapes of Voronoi cells.
...
\nnewtext{
More recently, Doyle et al.~\cite{Doyle2019} and Javid et al.~\cite{Javid2019} generated pebble mosaics 
