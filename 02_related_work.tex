...
Given an input greyscale image, he incorporated pixel intensities into the centroid calculation, 
so that points elements are attracted to darker regions and the resulting point distribution
