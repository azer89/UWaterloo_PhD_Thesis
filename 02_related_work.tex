...
earlier methods.}
\nnewtext{However, the FFT-based method cannot rotate the elements,
...
\nnewtext
{
Mosaics generated using generalized Lloyd's methods.
(a) Animatosaics~\cite{Smith2005}.
...
\nnewtext
{
This section discusses packing methods that fall into the category of data-driven ((Figure~\ref{fig_taxonomy_method})b) and 
...
number of letter elements composing one or two words (Figure~\ref{fig_taxonomy_method}c and ~\ref{fig_calligraphy_packing}). 
...
so they are not able to preserve the typeface of the letters.
