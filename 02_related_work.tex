...
A framework to generate metamorphosis tilings is proposed by Kaplan~\cite{Kaplan2010}.
}
...
computing contact point networks of rigid elements, which can be seen in Figure~\ref{fig_related_gal_ma_chen}c.
