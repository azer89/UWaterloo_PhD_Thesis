...
We also considered the idea to evaluate distance transforms only on two structures: Voronoi cell boundaries or a medial axis.
In the end, we scrapped the idea as we find these structures have underlying issues, 
but we think discussing them would explain questions that might arise 
regarding our decision to use proposed quantitative metrics. 
%but we think discussing them would explain our
%research process that resulted in quantitative metrics.
}
