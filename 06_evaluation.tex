...
performed a qualitative evaluation by performing a user study.
They asked 13 participants, each was shown a random packing and had to give 1-to-6 ratings 
in terms of their overall preference, shape coupling, and stylishness.
}

\newtext
{
In the context of 2D packing, we define a \textbf{distance transform} as a 2D image whose pixels labelled with distance values. 
...
\newtext
{
The spectral packing~\cite{Dalal2006} utilized a \textbf{centroidal area Voronoi diagram} for their optimization approach.
...
\newtext
{
An alternative to handle concave elements is to generate a \textbf{medial axis} from the negative space.
