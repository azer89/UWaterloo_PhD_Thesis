...
\mynote{Maybe talk about other principles like in FLOWPAK and we limit ourselves to the evenness, 
but its already described in future work.}
...
In this chapter, we discuss quantitative measurements of 2D packing
quality that can be used to evaluate our results and subsequent work. 
We believe that perceived packing quality is tied to the evenness of negative space.
...
\mynote{Discuss Wong and FLOWPAK? Gieseke?}
...
but past work in measuring packing quality is still inadequate.
}

\textbf{Qualitative Principles:}
Chapter~\ref{chapter_flowpak} and Wong et al.~\cite{Wong1998} describe
a few qualitative principles should be followed to create a good packing, such as
balance, flow, uniformity amidst variety, and boundary.
Gieseke et al.~\cite{Gieseke2017} also suggested that symmetry is an important
for creating decorative ornaments.
We believe that those principles are useful for a user study. % MEHHHH
...
They performed two user studies: a pile-sorting study and a pairwise comparison study.
In Pyramid of Arclength Descriptor (PAD)~\cite{Kwan2016}, Kwan et al. 
performed a user study of 13 participant.
Each was shown a random packing and had to give ratings from 1 (worst) to 6 (best)
to three categories: their subjective preference, 
element boundary coupling, and stylishness.
}
...
However, they did not further discuss whether it can be used for quantitative evaluation.
...
%The stability constraint requires weak part detection, for example a single thin element would likely to break
%so that structural supports need to be added.
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Analyzing the Negative Space}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
