...
\newtext{
The \textbf{spherical contact probability} (SCP) is the probability that a 
...
\newtext{
Saputra et al.~\cite{Saputra2018} calculated a discrete approximation
of the SCP.  We can compute it more accurately geometrically, by offsetting the negative
...
concentration of density around $d_\mathrm{gap}/2$.  In Fig.~\ref{hsr_viz},
...
\newtext{
Fig.~\ref{pad_comparison} compares
...
\newtext{
In Fig.~\ref{balabolka_comparison} we show a RepulsionPak result created 
using the elements from the artist-made packing in Fig.~\ref{packing_example}.
...
As shown in Fig.~\ref{fifteen_packings}, a low value of
...
\item \newtext{We would like to conduct experiments that investigate the
  ...
  the packing in Fig.~\ref{balabolka_comparison}b, created with RepulsionPak,
  was packed more tightly than the artist's packing in
  Fig.~\ref{balabolka_comparison}a, even though both have the same total
...
\item \newtext{
  ...
  the squares in Fig.~\ref{hsr_viz}e.  It would be worthwhile to repeat
...
\item \newtext{When comparing calibrated packings, SCPs communicate 
...
\item We would like to develop additional metrics to evaluate
  ...
  At a higher level, Saputra et al.~\cite{Saputra2017} argue that visual flow and
...
\item \mynote{edit} Saputra et al.~\cite{Saputra2018} previously studied a set of
