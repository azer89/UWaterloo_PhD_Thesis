...
\nnewtext
{
There are three ideas that we would like to explore to improve our metrics.
First, we would like to conduct experiments that investigate the
 ...
 Second, we would like to use different offsetting for SCP.
 ...
 Third, we would like to investigate a better visualization for SCP.
 When comparing calibrated packings, SCPs communicate 
  differences in the evenness of negative space, but the differences 
