...
One idea is to analyze $r$ values only on a medial axis since they can be considered as widths of negative space gaps between elements.
However, creating a high quality medial axis is difficult,
as shown in Figure~\ref{fig_skeleton}, the issue is the large number of problematic branches
...
{\label{fig_skeleton}
\newtext{
    A medial axis generated from negative space of the Unilever packing using
