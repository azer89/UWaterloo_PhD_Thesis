...
\newtext
{We decide to compute \newtext{histogram of the distance transform} to evaluate the negative space.}
...
using overlap functions, spherical contact probabilities, and histograms of distance transform.
