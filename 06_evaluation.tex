...
\newtext{
    ...
    The whiter the color of a pixel, the farther it is from the nearest boundary.}
  }
\end{figure}
...
\newtext
{
\textbf{Related work in qualitative evaluation:}
...
\newtext
{
\textbf{Related work in quantitative evaluation:}
...
Their quantitative measurements are related to satisfying manufacturing constraints, 
such as connectivity or stability.
The connectivity constraint requires element boundaries to touch with each other, more contact points mean a better strength.
...
%, they want element boundaries to
%connect with each other. 
%More connected boundaries mean an increased strength so 
%that printed objects can resist excessive force and avoid breaking.
%\mynote{structurel stability}
}
...
%Below we discuss \textbf{centroidal area Voronoi diagrams} and \textbf{medial axes}, since
%the ridges on both structures correspond with ridges in the distance transform.
%These ridges form a separation structure, which is related to \textbf{centroidal area Voronoi diagrams} and \textbf{medial axes}
...
In Figure~\ref{fig_skeleton}, the medial axis is a graph-like structure containing branches that extend to element concavities.
