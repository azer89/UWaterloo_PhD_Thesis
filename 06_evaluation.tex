...
but we get inspiration from their work to develop a metric based on shape overlaps that we describe in the next section.
...
GLCM works best for analyzing dense point distributions, but it unfortunately cannot be used to analyze shape arrangements.
