...
Left: Unilever logo packing of 25 elements inside a ``U'' container. 
Right: Negative space which is the remaining area that is not claimed by the elements. }
\end{figure}
...
Left: A packing of autumn-themed elements, created by Balabolka. Right: A packing of abstract-shaped elements, created by ComicVec-
tor703. }
\end{figure}
...
{\label{fig_woodland} 
Woodland floor leaves by James Brunt. }
\end{figure}
...
%A packing can effectively convey a relationship between a unified whole (the
...
Figure \ref{fig_woodland} is a packing created by leaves of different shapes and sizes.
