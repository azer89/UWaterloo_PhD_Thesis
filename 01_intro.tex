...
\item \textbf{Uniformity Amidst Variety.} Repeated elements must balance
  ...
  Gombrich \nnewtext{also wrote} eloquently on the role of variation in 
  design~\cite{Gombrich}.
  \nnewtext{In the context of procedural art, Galanter discussed the trade off between order and disorder~\cite{Galanter2003}.}
...
\nnewtext{Our goal is to fill each container with elements,
