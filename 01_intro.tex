...
\newtext
{
(a) Unilever packing that consists of 25 elements inside a ``U'' container. \newline
...
The flow visual style on both examples gives a packing an impression of progression and movements.
}
...
\item AnimationPak is a method to pack 2D animated elements inside a static 2D container. 
	...
	and we view the animated packing problem as a three-dimensional packing in that domain.
