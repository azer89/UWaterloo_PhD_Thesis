...
\begin{conditions}
\newtext{s\_gap} \enspace & the desired space between streamlines \\
\newtext{s\_max} & the maximum desired streamline length \\
\newtext{s\_min} & the minimum desired streamline length   
\end{conditions}
...
%\mynote{vector fields, trace streamlines, bend elements}

%We demonstrated a method to create ornamental packings
%in which vector fields are used to provide a sense of visual flow.
