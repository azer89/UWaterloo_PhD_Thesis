...
\nnewtext{Algorithm~\ref{iterative_refinement_algorithm}
gives the overall method.} We have found that
...
\nnewtext{$g_\mathrm{limit}=0.005\,l_\mathrm{canvas}$ (Recall that $l_\mathrm{canvas}$} is the \nnewtext{canvas size}
