...
with the focus on the flow principle.
}
...
%input\_size
We define \nnewtext{$b_\mathrm{box}$} to be the bounding box size %or the maximum of the combined width or height
...
$s$, again using \nnewtext{$0.005\,b_\mathrm{box}$}, and at each point generate two more
...
\nnewtext{$g_\mathrm{limit}=0.005\,b_\mathrm{box}$ (Recall that $b_\mathrm{box}$} is the bounding box
...
\nnewtext{$g_\mathrm{limit}=0.005\,b_\mathrm{box}$.}
